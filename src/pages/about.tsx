      ...
      <div className="mt-12 py-8 px-8">
        ...
        <div className="tile py-10 xl:px-20 flex flex-row justify-between gap-x-14">
          {tiles.map((tile, index) => (
            <div key={index} className="w-3/12 aspect-[3/2] gap-y-5 flex flex-col justify-center align-center border rounded group hover:bg-secondary hover:text-white">
              ...
              <div className="flex flex-col justify-center">
                <h4 className="text-xl text-center font-extrabold">{tile.upText}</h4>
